...
This fork of plugin implements support of the [Jitsi Token Moderation Plugin](https://github.com/nvonahsen/jitsi-token-moderation-plugin).
...
1. Clone this repository or download it in .zip format.
2. Upload the `jitsi-2.0.1.tar.gz` file through **System Console > Plugin Management > Upload Plugin**, or manually upload it to the Mattermost server under plugin directory. See [documentation](https://docs.mattermost.com/administration/plugins.html#set-up-guide) for more details.
